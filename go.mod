...
// 	github.com/icecreamhotz/movie-ticket/models v0.0.0 => ./models
// 	github.com/icecreamhotz/movie-ticket/routes v0.0.0 => ./routes
// 	github.com/icecreamhotz/movie-ticket/utils v0.0.0 => ./utils
// )
